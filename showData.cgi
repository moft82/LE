...
my $key=param('key');
my $file_input=param('file');
my $file="data/lecture/$key/$file_input";
open(IN,$file);
$lecture=<IN>;
$title=<IN>;
$professor=<IN>;
				...
				<!-- Main -->
					<div id=\"main\">
						<div class=\"inner\">
							...
							<!-- Header -->
								<header id=\"header\">
									<a href=\"list.cgi?key=$lecture\" class=\"logo\"><strong>$lecture</strong></a>$professor professor in $year
									<ul class=\"icons\">";
									if($data_cookie[1] ne "admin"){
										$writer="anonymous";
									}
									print"
										<li>written by : $writer</li>
